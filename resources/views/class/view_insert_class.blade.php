		...
		<div class="card-body card-block" >
			<form action="{{ route('class.process_insert_class') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="row form-group">
					<div class="col col-md-3"><label for="text-input" class=" form-control-label">Tên Lớp</label></div>
					<div class="col-12 col-md-9"><input type="text" id="text-input" name="name" placeholder="Text" class="form-control" value="{{ old('name') }}">{{ $errors->first('name') }}
					</div>
				</div>
